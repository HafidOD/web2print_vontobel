...
export default function Paginate({ productLength }) {
      ...
      <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p class="text-sm text-gray-700">
            ...
            of
            <span class="font-medium"> {productLength} </span>
            results
          </p>
        </div>
        <div>
          ...
          >
            ...
            <a
              href="#"
              aria-current="page"
              class="relative z-10 inline-flex items-center bg-primaryBlue px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              1
            </a>
            <a
      ...
      <div>
        <div>
          <p>
            ...
            of <span>{products?.products.length}</span> results
          </p>
        </div>
        <div>
